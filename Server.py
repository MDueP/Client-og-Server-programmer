...
while True:    #    while loop, der bare kører konstant, eller så længe den er True
    ...
    tid.setFormatter(format) #    da vi gemte den tidliger formattering og handler..... altså måden vi gemmer data på, samt dataens overordenede navn i variablen tid, er det vigtigt at formattere den variabel til pythons logging funktion
